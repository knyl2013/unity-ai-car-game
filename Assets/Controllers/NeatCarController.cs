...
public class NeatCarController : UnitController
{
    ...
    private void Start() {
        // Debug.Log("Start()!");    
        // startPosition = new Vector3(2.53f, 4.38f, 0f);
        // startRotation = new Vector3(0, -360, -360);
        // AudioSource audio = GetComponent<AudioSource>();
        // audio.mute = true;
        
        //startPosition = new Vector3(-12.7f, 4.38f, -23.6f);
        startPosition = new Vector3(0f, 0f, 0f);
        startRotation = new Vector3(0, 90, -360);
    }
    ...
    private void FixedUpdate()
    {
        ...
        if (IsRunning) {
            ...
            bool hitWall = aSensor == 0.05f || bSensor == 0.05f || cSensor == 0.05f;
            if (hitWall)
            {
                Reset();
            }
